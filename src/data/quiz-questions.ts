...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: "q10",
    question: "🥸 Dans un parc, elles apparaissent quand les utilisateurs ne suivent pas le parcours imaginé",
  ...
  {
    id: "q8",
    question: "🍎 ('b' + 'a' + + 'a' + 'a').toLowerCase(), on cherche un fruit... ",
    acceptedAnswers: ["Banana, Banane"],
    answer: "Banana",
    difficulty: "difficult",
    funFact: "L'une des nombreuses bizarreries de Javascript... ",
  },
  {
    id: "q9",
  ...
  {
    id: "q11",
    question: "♿️ Pourcentage de sites web français pleinement accessibles",
  ...
  {
    id: "q6",
    question: "🎺 Avant de tyranniser des jeunes musiciens, il a tyrannisé Peter Parker",
